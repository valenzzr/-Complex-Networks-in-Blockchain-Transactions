# =====================================================
# Ethereum Transaction Network Analysis (Enhanced, No-GNN)
# 保留：结构指标、严谨幂律检验、多维中心化（价值流）、时间切片与动态中心性
# 移除：Temporal GNN 基线（GConvGRU）
# =====================================================
...
# using 4 well-known addresses as seeds
...
# betweenness centrality computation control
BETWEENNESS_MAX_NODES = 15000
BETWEENNESS_K_SAMPLE = None  # e.g. 400 for sampling; None = exact
...
WINDOW_DAYS = 30            # sliding window (days)
STEP_DAYS = 7               # step size (days)
TOPK_PLOT = 10              # sequential top-K wallets to plot
BETWEENNESS_SAMPLE_K = 400  # betweenness sampling for dynamic centrality
...
# GEXF attributes export
print("\n=== Exporting GEXF with node metrics ===")
for n in G.nodes():
